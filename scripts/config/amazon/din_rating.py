...
_fea_config_order = ('user_id', 'item_id', 'category_ids', 'item_id_seq_pos', 'category_ids_seq_pos', 'item_id_seq_neg', 'category_ids_seq_neg')
...
"""
SHARED_EMB_CONFIG = {
    'item_emb': ('item_id', 'item_id_seq_neg', 'item_id_seq_pos'),
